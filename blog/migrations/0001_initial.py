    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('content', models.TextField(blank=True, help_text='Comments are moderated. Only those approved by the Moderator will be shown here.', null=True, verbose_name='Comments:')),
                ('status', models.CharField(choices=[('REJECT', 'REJECT'), ('PENDING', 'PENDING'), ('APPROVED', 'APPROVED')], default='PENDING', max_length=10)),
